 ...
 */
Sidebar.prototype.thumbWidth = 85;
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
		...
		this.createVertexTemplateEntry('nodeType=start;ellipse;whiteSpace=wrap;html=1;aspect=fixed;fillColor=#FFFFFF;strokeColor=#000000;strokeWidth=2;', 50, 50, '开始', '', null, null, 'circle'),
		this.createVertexTemplateEntry('nodeType=end;ellipse;shape=doubleEllipse;whiteSpace=wrap;html=1;aspect=fixed;', 50, 50, '结束', '', null, null, 'double circle'),
		this.createVertexTemplateEntry('nodeType=task;shape=ext;rounded=1;html=1;whiteSpace=wrap;', 90, 45, '子流程', '', null, null, 'bpmn task process'),
	 	//this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;fillColor=#007FFF;opacity=70;strokeColor=none;', 120, 60, '', 'Rounded Rectangle', null, null, 'rounded rect rectangle box'),
		...
		// this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Square', null, null, 'square'),
	 	...
	 	// this.createVertexTemplateEntry('nodeType=condition;rhombus;whiteSpace=wrap;html=1;', 50, 50, '', '条件判断', null, null, 'diamond rhombus if condition decision conditional question test'),
		...
		//     return this.createEdgeTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Curve');
	 	...
	 	// this.createEdgeTemplateEntry('endArrow=classic;startArrow=classic;html=1;', 50, 50, '', '双向连线', null, lineTags + 'bidirectional'),
	 	// this.createEdgeTemplateEntry('endArrow=classic;html=1;', 50, 50, '', '单向连线', null, lineTags + 'directional directed')
	];
