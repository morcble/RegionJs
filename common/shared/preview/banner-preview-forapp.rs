...
<div id="REGION" class="hidden" style="background: darkslategray;padding:0rem; overflow: auto;">
	<div style="height: 100%;position: absolute;right: 0rem;top:0rem">
		 <span class="fa-solid fa-remove hidden" aria-hidden="true" onclick="RegionUtil.closeModalWindow()" style="z-index:100;color:white;-webkit-text-stroke:4px darkslategray"></span>
	</div>
