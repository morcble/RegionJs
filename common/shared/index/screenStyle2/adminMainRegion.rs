...
var REGION = {
		...
		init:function(treeRootNodeData){
			...
			var loadContentPromise = RegionUtil.loadRegion(curRegion.find(".contentwrapper-holder"),RS.appendParaMapToUrl("common/shared/index/screenStyle2/screensHolder.rs",paraMap));
