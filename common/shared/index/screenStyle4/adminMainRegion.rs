...
var REGION = {
		...
		init:function(treeRootNodeData){
			...
			if(header==null)header="common/shared/index/screenStyle4/header.rs";
			...
			var loadContentPromise = RegionUtil.loadRegion(curRegion.find(".contentwrapper-holder"),RS.appendParaMapToUrl("common/shared/index/screenStyle4/screensHolder.rs",paraMap));
