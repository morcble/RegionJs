...
var REGION = {
		...
		prompt:function(rsUrl){
			var curRegion = this;
			var cardId = "card"+RS.getUUID();
			var promptCard = "<div cardId='"+cardId+"' class='card "+cardId+" movein-animation1-class'></div>";
			RS.insertAfter(curRegion,curRegion.find(".brace")[0],promptCard);
		...
		closeCard:function(cardId){
			...
			cardDiv.removeClass("movein-animation1-class").addClass("moveout-animation4-class");
		}
};
...
RegionUtil.ready(function(){
	...
	staticRegion.prompt = REGION.prompt;
